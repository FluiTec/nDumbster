...
using nDumbsterCore.pop.Header;
using nDumbsterCore.pop.Traverse;

namespace nDumbsterCore.pop
{
	/// <summary>
	/// This is the root of the email tree structure.<br/>
	/// <see cref="pop.MessagePart"/> for a description about the structure.<br/>
	/// <br/>
	...
	public class Message
	{
		...
		/// <br/>
		/// <see cref="pop.MessagePart.IsText"/> for MessageParts which are considered to be text versions.<br/>
		/// <br/>
		...
		/// <br/>
		/// <see cref="pop.MessagePart.IsAttachment"/> for MessageParts which are considered to be attachments.
		/// </summary>
